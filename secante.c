/* Método da Secante para o cálculo da raiz de uma funcao */
...
int main()
{
double x0, x1, epsilon, ordem, razao, taxa, f0, f1;
...
scanf("%lf", &epsilon);
printf("\n");
printf("Entre com a estimativa inicial x0: ");
scanf("%lf", &x0);
printf("\n");
printf("Entre com a estimativa inicial x1: ");
scanf("%lf", &x1);
printf("\n");
